...
import { getAllOtherArtApiFunction } from "@/lib/utils/apiFunctions";
...
const Components = () => {
  ...
  useEffect(() => {
    async function getData() {
      try {
        setIsLoading(true);
        const res = await getAllOtherArtApiFunction(
          skip,
          limit,
          sortByDate,
          sortByTitle
  ...
  return (
    <div>
      <div>
        <SearchInput artObjectType={ArtObjectType.OTHER}/>
      </div>
