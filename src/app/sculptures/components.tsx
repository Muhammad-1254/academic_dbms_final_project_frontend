...
import {  getAllSculptureApiFunction } from "@/lib/utils/apiFunctions";
...
const Components = () => {
  ...
  useEffect(() => {
    async function getData() {
      try {
        setIsLoading(true);
        const res = await getAllSculptureApiFunction(
          skip,
          limit,
          sortByDate,
          sortByTitle
  ...
  return (
    <div>
      <div>
        <SearchInput artObjectType={ArtObjectType.SCULPTURE}/>
      </div>
